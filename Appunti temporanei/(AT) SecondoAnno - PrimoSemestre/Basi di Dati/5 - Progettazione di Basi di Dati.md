...
2. **Accorpamento del genitore nelle figlie**. Si elimina l’entità genitore $E_{0}$. Per l’ereditarietà, gli attributi di $E_{0}$, il suo identificatore e le relazioni cui partecipava, sono aggiunti alle figlie E1 e $E_{2}$. Le relazioni R11 ed R12 rappresentano la restrizione della relazione R1 sulla occorrenze di E1 ed E2. La cardinalità delle associazioni presenti non vengono alterate.